...
public class FE_Pipeline_TransitionToLonglist_AddResponsibleUserAndTeamPage extends BasePage {
    ...
    public FE_Pipeline_TransitionToLonglist_AddResponsibleUserAndTeamPage(WebDriver newDriver, WebDriverWait newWait) {
